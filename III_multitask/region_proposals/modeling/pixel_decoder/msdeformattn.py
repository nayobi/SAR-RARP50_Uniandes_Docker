...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        transformer_enc_layers = cfg.MODEL.SEM_SEG_HEAD.TRANSFORMER_ENC_LAYERS  # a separate config
        ...
        for idx, in_channels in enumerate(self.feature_channels[:self.num_fpn_levels]):
            lateral_norm = nn.GroupNorm(32, conv_dim) #get_norm(norm, conv_dim)
            output_norm = nn.GroupNorm(32, conv_dim) #get_norm(norm, conv_dim)
