...
from models.utils import round_width, validate_checkpoint_wrapper_import
...
class MViT(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        for idx, task in enumerate(self.tasks):
            if task in ['tools','segmentation']: #== 'tools' or task == 'actions':
                # breakpoint()
    ...
    def forward(self, x, features, idxs):
        ...
        for task in self.tasks:
            ...
            if task in ['tools','segmentation']:
                ...
                out_features = extra_head(t, features, idxs)
