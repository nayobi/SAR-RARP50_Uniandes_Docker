...
_C.AVA.LABEL_MAP_FILE = ""

# The name of the file to the ava exclusion.
_C.AVA.EXCLUSION_FILE = ""

# The name of the file to the ava groundtruth.
_C.AVA.GROUNDTRUTH_FILE = ""
...
# ---------------------------------------------------------------------------- #
_C.FASTER = CfgNode()
_C.FASTER.TRANS = False
_C.FASTER.ENABLE = False
_C.FASTER.MOVE_LOSS_WEIGHTS = False
_C.FASTER.FREEZE_HALF = False
_C.FASTER.FREEZE_ALL = False
_C.FASTER.FEATURES_TRAIN = ''
_C.FASTER.FEATURES_VAL = ''

# ---------------------------------------------------------------------------- #
# PRETRAIN CONFIGS
# ---------------------------------------------------------------------------- #
_C.PRETRAIN = CfgNode()
_C.PRETRAIN.ENABLE = False
_C.PRETRAIN.FREEZE = False
_C.PRETRAIN.DIM = 2048
_C.PRETRAIN.PRED_DIM = 512

# RoCL
_C.PRETRAIN.ATTACK_TYPE = 'linf'
_C.PRETRAIN.ATTACK_TO = 'other'
_C.PRETRAIN.REGULARIZE_TO = 'other'
_C.PRETRAIN.ADVTRAIN_TYPE = 'Rep'
_C.PRETRAIN.LAMBDA = 256
_C.PRETRAIN.EPSILON = 0.0314
_C.PRETRAIN.ALPHA = 0.007
_C.PRETRAIN.MIN = 0
_C.PRETRAIN.MAX = 1
_C.PRETRAIN.K = 20
_C.PRETRAIN.TEMPERATURE = 0.5
_C.PRETRAIN.LOSS = 'sim'
_C.PRETRAIN.LR_MULTIPLIER = 15.0
_C.PRETRAIN.EXPANSION = 768
_C.PRETRAIN.LARS = False
_C.PRETRAIN.RANDOM_START = True
